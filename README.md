...
Standard log-loss training ignores downstream causal tasks, leading to bias and variance explosions in Inverse Probability Weighting (IPW) estimators. To fix this, we derive a **task-specific proper scoring rule** and its associated **canonical link function** to minimize a local upper bound on the IPW Mean Squared Error (MSE). 
...
We provide plug-and-play estimators. 
